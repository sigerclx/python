...
def OCR_lmj(img_path):
    ...
    # 去掉图片中的噪声（孤立点）
    out = cut_noise(out)
    #outfile ="D:\Python\python-book01\2019\2019-11\yanzheng_pic\"
    #answer = img_path.split('.')[0]
    
    img_path=img_path.replace('.png','1.png')
    img_path=img_path.replace('.jpg','1.jpg')
    print (img_path)
...
def main():
    ...
    # 识别指定文件目录下的图片
    # 图片存放目录figures
    dir = r'D:\Python\python-book01\2019\2019-11\yanzheng_pic'
    total_c6ount = 0 
    correct_count = 0  # 图片总
    ...
    OCR_lmj(image_path)
    '''
    image_path = r'D:\Python\python-book01\2019\2019-11\yanzheng_pic\yzm104925.jpg'
    OCR_lmj(image_path)
